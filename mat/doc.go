...
AlmostEqual(m1, m2) will always be implemented as non-method function calls.

Supported binary Matrix operations are Mult, Add, Sub, and AlmostEqual. Supported
